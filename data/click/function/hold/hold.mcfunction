...
execute if score @s hold_tick2 matches 4 run function click:hold/hold_old
execute if score @s click > @s hold_old if score @s hold_tick matches ..3 run function click:hold/hold_over
execute if score @s hold_tick matches 1..3 run function click:hold/hold_test
