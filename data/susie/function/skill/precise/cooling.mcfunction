...
$item replace entity @s container.1 with bread[minecraft:custom_name='{"text":"冷却中...","color":"red"}',minecraft:max_stack_size=$(cooling),food={eat_seconds:999999999,nutrition:0,saturation:0},custom_data={susie:precise,cooling_queue:1}] $(cooling)
