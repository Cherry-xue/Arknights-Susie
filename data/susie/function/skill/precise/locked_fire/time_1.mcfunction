...
tp @e[tag=unit_1] ~-1 ~1.7 ~ facing entity @e[tag=locked,limit=1]
tp @e[tag=unit_2] ~1 ~1.7 ~ facing entity @e[tag=locked,limit=1]
function susie:skill/rage/random {"unit":"1"}
function susie:skill/rage/random {"unit":"2"}

scoreboard players set precise_attack_times susie 1
