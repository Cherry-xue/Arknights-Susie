...
execute as @e[tag=follow] at @s run summon armor_stand ^ ^1 ^-0.3 {Tags:[unit_2,unit],Small:1b,NoGravity:1b,Invisible:1b,ShowArms:1b,Pose:{RightArm:[-90f,90f,0f]},Marker:1b,HandItems:[{id:"carrot_on_a_stick",count:1b},{}]}
execute as @e[tag=follow] at @s run summon armor_stand ^ ^1 ^-0.3 {Tags:[unit_3,unit],Small:1b,NoGravity:1b,Invisible:1b,ShowArms:1b,Pose:{RightArm:[-90f,90f,0f]},Marker:1b,HandItems:[{id:"carrot_on_a_stick",count:1b},{}]}
...
##粒子效果
execute as @e[tag=follow] at @s run summon armor_stand ~ ~1 ~ {Tags:[sparkle_particle],Small:1b,NoGravity:1b,Invisible:1b,Marker:1b}
