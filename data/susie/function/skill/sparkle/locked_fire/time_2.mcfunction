...
execute if entity @s[tag=sparkle_locked_1] run tp @e[tag=unit_1] ~-0.45 ~1.7 ~0.89 facing entity @e[tag=sparkle_locked_1,limit=1]
execute if entity @s[tag=sparkle_locked_2] run tp @e[tag=unit_2] ~0.45 ~1.7 ~-0.89 facing entity @e[tag=sparkle_locked_2,limit=1]
...
scoreboard players set sparkle_attack_times susie 2
